...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
		...
		Uri gSearchEngine = Uri.parse(URL);

        Intent baseIntent = null;
		baseIntent = new Intent(Intent.ACTION_VIEW,gSearchEngine);
		...
		switch (requestCode) {
			case (GET_TEXT_REQUEST_CODE):
				if (resultCode == Activity.RESULT_OK)
					mUserTextView.setText(data.getStringExtra(Intent.EXTRA_RETURN_RESULT));
				break;
		}
